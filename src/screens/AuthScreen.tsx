        ...
        <View style={styles.logoContainer}>
            <View style={styles.ballOuter}>
                <Svg width="160" height="160" viewBox="0 0 100 100">
                    <Circle cx="50" cy="50" r="49.5" fill="#0f172a" stroke="#ffffff" strokeWidth="1.5" />
...
const styles = StyleSheet.create({
    ...
    ballOuter: { width: 160, height: 160, borderRadius: 80, alignItems: 'center', justifyContent: 'center', position: 'relative', shadowColor: '#38bdf8', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.3, shadowRadius: 20 },
